...
if __name__ == "__main__":
    ...
    print()
    print(f"🤖 Модель текста: {settings.gemini_text_model}")
    print(f"👁️ Модель vision: {settings.gemini_vision_model}")
    print(f"🔑 API ключ: {'✓ Настроен' if settings.gemini_api_key else '✗ НЕ ЗАДАН!'}")
    print()
    print("-" * 60)
